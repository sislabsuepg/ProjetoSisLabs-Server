...
export default class RelatorioService {
    async gerarRelatorioAcademicoPorCurso(cursoId: number, res: Response) {
        ...
        const addRodape = (currentPage: number) => {
            ...
            doc.fontSize(8).font('Helvetica').fillColor(CORES.cinzaMedio)
        ...
        try {
            ...
            if (emprestimos.length === 0) {
                ...
                doc
                    .fontSize(11)
                    .font('Helvetica')
                    .text(`A busca por registros de empréstimos para alunos do curso de "${nomeCurso}" não retornou resultados.`, { align: 'center' })
            ...
            doc.fontSize(16).text('Ocorreu um erro ao gerar o relatório.', { align: 'center' });
        } finally {
            doc.end();
        }
    }
        ...
        try {
            ...
            if (emprestimos.length === 0) {
                ...
                doc
                    .fontSize(11)
                    .font('Helvetica')
                    .text(`A busca por registros de empréstimos para o acadêmico de RA: "${nomeAluno}" não retornou resultados.`, { align: 'center' })
    ...
    async gerarRelatorioEmprestimo(laboratorioId: number | null, dataInicio: Date | null, dataFim: Date | null, res: Response) {
        ...
        try {
            ...
            const nomeLaboratorio = laboratorioId ? await Laboratorio.findByPk(laboratorioId).then(lab => lab?.nome) : 'Todos os Laboratórios';
            ...
            if (emprestimos.length === 0) {
                ...
                doc
                    .fontSize(11)
                    .font('Helvetica')
                    .text(`A busca por registros de empréstimos não retornou resultados.`, { align: 'center' });
